...
export const ALL_ENDPOINTS: ApiEndpoint[] = [
  ...
  },
  {
    ...
    description: "Salva metadados do arquivo apos upload. Valida tipo MIME, tamanho e cotas.",
    params: [
  ...
  },
  {
    ...
    description: "Retorna URL de download para um arquivo. URL expira apos alguns minutos.",
    params: [
